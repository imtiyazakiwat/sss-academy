  ...
  return (
    <footer className="relative overflow-hidden bg-navy-950 text-navy-200">
      ...
      <Container className="relative py-8 sm:py-10">
              ...
              {socials.map((s) => (
                <li key={s.href}>
                  <a
                    ...
                    aria-label={s.label}
                    className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-navy-200 transition-colors hover:border-white/35 hover:text-white"
                  >
                    {socialIcons[s.label]}
                  </a>
                </li>
        ...
        <div className="mt-8 flex flex-col gap-3 border-t border-white/10 pt-4 text-xs text-navy-400 sm:flex-row sm:items-center sm:justify-between">
