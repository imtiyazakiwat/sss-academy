  ...
  return (
    <footer
      ...
      style={{
        ...
        boxShadow: "inset 0 6px 24px -6px rgb(0 0 0 / 0.06)",
      }}
    >
      <Container className="py-12 sm:py-16">
        ...
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-4">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-[#6B6A67]">
          ...
          <div className="md:col-span-3">
            ...
            <address className="mt-4 space-y-1 text-sm not-italic leading-relaxed text-[#6B6A67]">
        ...
        {/* Bottom bar */}
        <div className="mt-10 flex flex-col gap-2 border-t border-[#E8E6DE] pt-6 text-xs text-[#6B6A67] sm:flex-row sm:items-center sm:justify-between">
          <p>© {new Date().getFullYear()} SSS Academy. All Rights Reserved.</p>
          <p>
