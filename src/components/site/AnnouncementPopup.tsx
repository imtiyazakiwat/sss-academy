    ...
    >
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-4 px-6 pt-7 pb-6 text-center sm:px-8">
          ...
          <a
            href={`https://wa.me/91${banner.whatsappNumber || "7676831143"}?text=${encodeURIComponent(banner.whatsappMessage || "I am interested in ETL course")}`}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#1ebe57] sm:w-auto"
          >
            <WhatsAppIcon />
            Enquire on WhatsApp
          </a>
